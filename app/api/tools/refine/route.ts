...
import { editImageWithFal } from '@/lib/api/fal';
...
Output ONLY the new prompt text with no explanation, no quotes, no preamble.`,
        ...
        // Now generate the edited image with fal.ai SeeDream
        const result = await editImageWithFal(current_prompt, refinedPrompt);
